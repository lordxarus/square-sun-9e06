...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/square-sun-9e06)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/square-sun-9e06
```

A live public deployment of this template is available at [https://square-sun-9e06.templates.workers.dev](https://square-sun-9e06.templates.workers.dev)
